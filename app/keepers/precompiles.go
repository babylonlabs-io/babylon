...
func NewAvailableStaticPrecompiles(
	...
	epochingPrecompile, err := epochingprecompile.NewPrecompile(epochingKeeper, epochingMsgServer, epochingQuerier, checkpointingMsgServer, *stakingKeeper, stakingQuerier, CodecOptions.AddressCodec)
	if err != nil {
