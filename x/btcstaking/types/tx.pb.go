...
type MsgCreateFinalityProvider struct {
	...
	BsnId string `protobuf:"bytes,6,opt,name=bsn_id,json=bsnId,proto3" json:"bsn_id,omitempty"`
...
func (m *MsgCreateFinalityProvider) GetBsnId() string {
	if m != nil {
		return m.BsnId
	}
	return ""
...
type MsgBtcStakeExpand struct {
	...
	// the staking tx output. The staking tx output further needs signatures from
	// covenant and finality provider in order to be spendable.
	DelegatorSlashingSig *github_com_babylonlabs_io_babylon_v3_types.BIP340Signature `protobuf:"bytes,9,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
	// unbonding_time is the time lock used when funds are being unbonded. It is
	// be used in:
	// - unbonding transaction, time lock spending path
	// - staking slashing transaction, change output
	...
	// delegator_unbonding_slashing_sig is the signature on the slashing tx by the
	// delegator (i.e., SK corresponding to btc_pk).
	DelegatorUnbondingSlashingSig *github_com_babylonlabs_io_babylon_v3_types.BIP340Signature `protobuf:"bytes,14,opt,name=delegator_unbonding_slashing_sig,json=delegatorUnbondingSlashingSig,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BIP340Signature" json:"delegator_unbonding_slashing_sig,omitempty"`
...
type MsgAddCovenantSigs struct {
	...
	// submitted to babylon. The signature follows encoding in BIP-340 spec
	StakeExpansionTxSig *github_com_babylonlabs_io_babylon_v3_types.BIP340Signature `protobuf:"bytes,7,opt,name=stake_expansion_tx_sig,json=stakeExpansionTxSig,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BIP340Signature" json:"stake_expansion_tx_sig,omitempty"`
}
...
func (m *MsgAddBsnRewards) Reset()         { *m = MsgAddBsnRewards{} }
func (m *MsgAddBsnRewards) String() string { return proto.CompactTextString(m) }
func (*MsgAddBsnRewards) ProtoMessage()    {}
func (*MsgAddBsnRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_4baddb53e97f38f2, []int{19}
}
func (m *MsgAddBsnRewards) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddBsnRewards) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddBsnRewards.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddBsnRewards) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddBsnRewards.Merge(m, src)
}
func (m *MsgAddBsnRewards) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddBsnRewards) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddBsnRewards.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddBsnRewards proto.InternalMessageInfo

func (m *MsgAddBsnRewards) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *MsgAddBsnRewards) GetBsnConsumerId() string {
	if m != nil {
...
func (m *MsgAddBsnRewards) GetTotalRewards() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
...
func (m *MsgAddBsnRewards) GetFpRatios() []FpRatio {
	if m != nil {
		return m.FpRatios
	}
	return nil
...
func (m *FpRatio) Reset()         { *m = FpRatio{} }
func (m *FpRatio) String() string { return proto.CompactTextString(m) }
func (*FpRatio) ProtoMessage()    {}
func (*FpRatio) Descriptor() ([]byte, []int) {
	return fileDescriptor_4baddb53e97f38f2, []int{20}
}
func (m *FpRatio) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FpRatio) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FpRatio.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FpRatio) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FpRatio.Merge(m, src)
}
func (m *FpRatio) XXX_Size() int {
	return m.Size()
}
func (m *FpRatio) XXX_DiscardUnknown() {
	xxx_messageInfo_FpRatio.DiscardUnknown(m)
}

var xxx_messageInfo_FpRatio proto.InternalMessageInfo

// MsgAddBsnRewardsResponse defines the Msg/AddBsnRewards response type.
type MsgAddBsnRewardsResponse struct {
}

func (m *MsgAddBsnRewardsResponse) Reset()         { *m = MsgAddBsnRewardsResponse{} }
func (m *MsgAddBsnRewardsResponse) String() string { return proto.CompactTextString(m) }
func (*MsgAddBsnRewardsResponse) ProtoMessage()    {}
func (*MsgAddBsnRewardsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4baddb53e97f38f2, []int{21}
}
func (m *MsgAddBsnRewardsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddBsnRewardsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddBsnRewardsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddBsnRewardsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddBsnRewardsResponse.Merge(m, src)
}
func (m *MsgAddBsnRewardsResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddBsnRewardsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddBsnRewardsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddBsnRewardsResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgAddBsnRewards)(nil), "babylon.btcstaking.v1.MsgAddBsnRewards")
	proto.RegisterType((*FpRatio)(nil), "babylon.btcstaking.v1.FpRatio")
	proto.RegisterType((*MsgAddBsnRewardsResponse)(nil), "babylon.btcstaking.v1.MsgAddBsnRewardsResponse")
}
...
var fileDescriptor_4baddb53e97f38f2 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	AddBsnRewards(ctx context.Context, in *MsgAddBsnRewards, opts ...grpc.CallOption) (*MsgAddBsnRewardsResponse, error)
}
...
func (c *msgClient) AddBsnRewards(ctx context.Context, in *MsgAddBsnRewards, opts ...grpc.CallOption) (*MsgAddBsnRewardsResponse, error) {
	out := new(MsgAddBsnRewardsResponse)
	err := c.cc.Invoke(ctx, "/babylon.btcstaking.v1.Msg/AddBsnRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// AddBsnRewards defines a method to add additional rewards for finality providers
	// and their BTC delegators with specified distribution ratios
	AddBsnRewards(context.Context, *MsgAddBsnRewards) (*MsgAddBsnRewardsResponse, error)
}
...
func (*UnimplementedMsgServer) AddBsnRewards(ctx context.Context, req *MsgAddBsnRewards) (*MsgAddBsnRewardsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddBsnRewards not implemented")
}
...
func _Msg_AddBsnRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgAddBsnRewards)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).AddBsnRewards(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/babylon.btcstaking.v1.Msg/AddBsnRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AddBsnRewards(ctx, req.(*MsgAddBsnRewards))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddBsnRewards",
			Handler:    _Msg_AddBsnRewards_Handler,
		},
	},
...
func (m *MsgCreateFinalityProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BsnId) > 0 {
		i -= len(m.BsnId)
		copy(dAtA[i:], m.BsnId)
		i = encodeVarintTx(dAtA, i, uint64(len(m.BsnId)))
		i--
		dAtA[i] = 0x32
	}
	if m.Pop != nil {
...
func (m *MsgAddBsnRewards) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddBsnRewards) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddBsnRewards) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.BsnConsumerId) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.BsnConsumerId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Sender) > 0 {
...
func (m *FpRatio) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FpRatio) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FpRatio) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddBsnRewardsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddBsnRewardsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddBsnRewardsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddBsnRewards) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddBsnRewardsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddBsnRewards) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddBsnRewards: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddBsnRewards: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.TotalRewards = append(m.TotalRewards, types1.Coin{})
		...
		case 4:
			...
			m.FpRatios = append(m.FpRatios, FpRatio{})
...
func (m *FpRatio) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FpRatio: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FpRatio: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgAddBsnRewardsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddBsnRewardsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddBsnRewardsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
