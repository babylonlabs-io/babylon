...
type MsgCreateBTCDelegation struct {
	...
	BtcPk *github_com_babylonlabs_io_babylon_v2_types.BIP340PubKey `protobuf:"bytes,3,opt,name=btc_pk,json=btcPk,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340PubKey" json:"btc_pk,omitempty"`
	...
	DelegatorSlashingSig *github_com_babylonlabs_io_babylon_v2_types.BIP340Signature `protobuf:"bytes,10,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
...
type MsgAddCovenantSigs struct {
	...
	Pk *github_com_babylonlabs_io_babylon_v2_types.BIP340PubKey `protobuf:"bytes,2,opt,name=pk,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340PubKey" json:"pk,omitempty"`
	// staking_tx_hash is the hash of the staking tx.
	// It uniquely identifies a BTC delegation
	...
	UnbondingTxSig *github_com_babylonlabs_io_babylon_v2_types.BIP340Signature `protobuf:"bytes,5,opt,name=unbonding_tx_sig,json=unbondingTxSig,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340Signature" json:"unbonding_tx_sig,omitempty"`
