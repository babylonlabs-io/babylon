...
type MsgCreateBTCDelegation struct {
	...
	MultisigInfo *AdditionalStakerInfo `protobuf:"bytes,16,opt,name=multisig_info,json=multisigInfo,proto3" json:"multisig_info,omitempty"`
}
...
func (m *MsgCreateBTCDelegation) GetMultisigInfo() *AdditionalStakerInfo {
	if m != nil {
...
type MsgBtcStakeExpand struct {
	...
	// multisig_info is used when the given btc delegation is M-of-N multisig.
	// If nil, it is not a M-of-N multisig.
	MultisigInfo *AdditionalStakerInfo `protobuf:"bytes,17,opt,name=multisig_info,json=multisigInfo,proto3" json:"multisig_info,omitempty"`
}
...
func (m *MsgBtcStakeExpand) GetMultisigInfo() *AdditionalStakerInfo {
	if m != nil {
		return m.MultisigInfo
	}
	return nil
...
var fileDescriptor_4baddb53e97f38f2 = []byte{
	...
	,
}
...
func (m *MsgCreateBTCDelegation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			if m.MultisigInfo == nil {
				m.MultisigInfo = &AdditionalStakerInfo{}
			}
