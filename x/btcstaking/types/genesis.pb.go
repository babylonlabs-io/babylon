...
type BTCDelegator struct {
	...
	DelBtcPk *github_com_babylonlabs_io_babylon_v2_types.BIP340PubKey `protobuf:"bytes,3,opt,name=del_btc_pk,json=delBtcPk,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340PubKey" json:"del_btc_pk,omitempty"`
}
