...
type GenesisState struct {
	...
	// btc_consumer_delegators contains all the btc delegators
	// with the associated finality provider of a consumer chain
	BtcConsumerDelegators []*BTCDelegator `protobuf:"bytes,10,rep,name=btc_consumer_delegators,json=btcConsumerDelegators,proto3" json:"btc_consumer_delegators,omitempty"`
	// all consumer chain events
	ConsumerEvents []*ConsumerEvent `protobuf:"bytes,11,rep,name=consumer_events,json=consumerEvents,proto3" json:"consumer_events,omitempty"`
}
...
func (m *GenesisState) GetBtcConsumerDelegators() []*BTCDelegator {
	if m != nil {
		return m.BtcConsumerDelegators
	}
	return nil
}
...
var fileDescriptor_85d7b95fa5620238 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BtcConsumerDelegators) > 0 {
		for iNdEx := len(m.BtcConsumerDelegators) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BtcConsumerDelegators[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.BtcConsumerDelegators) > 0 {
		for _, e := range m.BtcConsumerDelegators {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BtcConsumerDelegators", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BtcConsumerDelegators = append(m.BtcConsumerDelegators, &BTCDelegator{})
			if err := m.BtcConsumerDelegators[len(m.BtcConsumerDelegators)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
