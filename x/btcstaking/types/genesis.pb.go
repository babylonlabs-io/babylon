...
type GenesisState struct {
	...
	AllowedMultiStakingTxHashes []string `protobuf:"bytes,11,rep,name=allowed_multi_staking_tx_hashes,json=allowedMultiStakingTxHashes,proto3" json:"allowed_multi_staking_tx_hashes,omitempty"`
...
func (m *GenesisState) GetAllowedMultiStakingTxHashes() []string {
	if m != nil {
		return m.AllowedMultiStakingTxHashes
	}
	return nil
}
...
var fileDescriptor_85d7b95fa5620238 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AllowedMultiStakingTxHashes) > 0 {
		for iNdEx := len(m.AllowedMultiStakingTxHashes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AllowedMultiStakingTxHashes[iNdEx])
			copy(dAtA[i:], m.AllowedMultiStakingTxHashes[iNdEx])
			i = encodeVarintGenesis(dAtA, i, uint64(len(m.AllowedMultiStakingTxHashes[iNdEx])))
			i--
			dAtA[i] = 0x5a
		}
	}
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.AllowedMultiStakingTxHashes) > 0 {
		for _, s := range m.AllowedMultiStakingTxHashes {
			l = len(s)
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedMultiStakingTxHashes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowedMultiStakingTxHashes = append(m.AllowedMultiStakingTxHashes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
