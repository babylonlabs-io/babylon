...
type Params struct {
	...
	DelegationCreationBaseGasFeeSat int64 `protobuf:"varint,14,opt,name=delegation_creation_base_gas_fee_sat,json=delegationCreationBaseGasFeeSat,proto3" json:"delegation_creation_base_gas_fee_sat,omitempty"`
}
...
func (m *Params) GetDelegationCreationBaseGasFeeSat() int64 {
	if m != nil {
		return m.DelegationCreationBaseGasFeeSat
	}
	return 0
}
...
var fileDescriptor_8d1392776a3e15b9 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DelegationCreationBaseGasFeeSat != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.DelegationCreationBaseGasFeeSat))
		i--
		dAtA[i] = 0x70
	}
...
func (m *Params) Size() (n int) {
	...
	if m.DelegationCreationBaseGasFeeSat != 0 {
		n += 1 + sovParams(uint64(m.DelegationCreationBaseGasFeeSat))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelegationCreationBaseGasFeeSat", wireType)
			}
			m.DelegationCreationBaseGasFeeSat = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DelegationCreationBaseGasFeeSat |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
