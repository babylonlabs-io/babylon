...
func (m *EventFinalityProviderStatusChange) GetNewStatus() string {
	if m != nil {
		return m.NewStatus
	}
	return ""
...
func (m *EventBTCDelegationCreated) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (m *EventCovenantQuorumReached) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (m *EventBTCDelegationInclusionProofReceived) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (m *EventBTCDelgationUnbondedEarly) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
func (m *EventBTCDelegationExpired) GetState() string {
	if m != nil {
		return m.State
	}
	return ""
...
var fileDescriptor_74118427820fff75 = []byte{
	...
	,
}
