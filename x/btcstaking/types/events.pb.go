...
func (m *EventCovenantSignatureRecevied) GetState() BTCDelegationStatus {
	if m != nil {
		return m.State
	}
	return BTCDelegationStatus_PENDING
...
type EventCoventatQuroumReached struct {
	...
	CovenantBtcPkHex string `protobuf:"bytes,2,opt,name=covenant_btc_pk_hex,json=covenantBtcPkHex,proto3" json:"covenant_btc_pk_hex,omitempty"`
	// state of the BTC delegation
	State BTCDelegationStatus `protobuf:"varint,3,opt,name=state,proto3,enum=babylon.btcstaking.v1.BTCDelegationStatus" json:"state,omitempty"`
}
...
func (m *EventCoventatQuroumReached) GetState() BTCDelegationStatus {
	if m != nil {
		return m.State
	}
	return BTCDelegationStatus_PENDING
...
var fileDescriptor_74118427820fff75 = []byte{
	...
	,
}
