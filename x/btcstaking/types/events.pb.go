...
type EventBTCDelegationCreated struct {
	...
	// extra_staker_btc_pk_hexs is the hex str of Bitcoin secp256k1 PK of the multisig staker that
	// create this BTC delegation. the PK follows encoding in BIP-340 spec.
	// if empty, it is NOT a M-of-N multisig btc delegation.
	ExtraStakerBtcPkHexs []string `protobuf:"bytes,12,rep,name=extra_staker_btc_pk_hexs,json=extraStakerBtcPkHexs,proto3" json:"extra_staker_btc_pk_hexs,omitempty"`
}
...
func (m *EventBTCDelegationCreated) GetExtraStakerBtcPkHexs() []string {
	if m != nil {
		return m.ExtraStakerBtcPkHexs
	}
	return nil
}
...
var fileDescriptor_74118427820fff75 = []byte{
	...
	0x13, 0xb6, 0x64, 0xf9, 0xdf, 0xc8, 0x71, 0x1c, 0xfe, 0xfc, 0x4b, 0x15, 0x35, 0x51, 0x1c, 0x25,
	0x31, 0xdc, 0xb4, 0x91, 0xf2, 0xc7, 0x6d, 0x0e, 0x05, 0x0a, 0x48, 0xb6, 0x1c, 0x29, 0x31, 0x12,
	...
	0x87, 0xa2, 0x88, 0x0f, 0xbd, 0xf6, 0x09, 0x8a, 0x82, 0xbb, 0x4b, 0x89, 0x94, 0xa9, 0xc4, 0x2e,
	...
	0xa6, 0x02, 0x77, 0x41, 0xeb, 0x11, 0x6a, 0x15, 0xf9, 0x5f, 0xb1, 0x94, 0xff, 0x21, 0x09, 0x97,
	...
	0xbb, 0x55, 0x1c, 0x28, 0x97, 0x20, 0xa5, 0x19, 0x86, 0x93, 0x49, 0x86, 0xb7, 0xf9, 0x92, 0x72,
	...
	,
}
...
func (m *EventBTCDelegationCreated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ExtraStakerBtcPkHexs) > 0 {
		for iNdEx := len(m.ExtraStakerBtcPkHexs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ExtraStakerBtcPkHexs[iNdEx])
			copy(dAtA[i:], m.ExtraStakerBtcPkHexs[iNdEx])
			i = encodeVarintEvents(dAtA, i, uint64(len(m.ExtraStakerBtcPkHexs[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
...
func (m *EventBTCDelegationCreated) Size() (n int) {
	...
	if len(m.ExtraStakerBtcPkHexs) > 0 {
		for _, s := range m.ExtraStakerBtcPkHexs {
			l = len(s)
			n += 1 + l + sovEvents(uint64(l))
		}
	}
...
func (m *EventBTCDelegationCreated) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraStakerBtcPkHexs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtraStakerBtcPkHexs = append(m.ExtraStakerBtcPkHexs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
