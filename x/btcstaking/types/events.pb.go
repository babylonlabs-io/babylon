...
type EventBTCDelegationCreated struct {
	...
	// multisig_staker_btc_pk_hexs is the hex str of Bitcoin secp256k1 PK of the multisig staker that
	// create this BTC delegation. the PK follows encoding in BIP-340 spec.
	// if empty, it is NOT a M-of-N multisig btc delegation.
	MultisigStakerBtcPkHexs []string `protobuf:"bytes,12,rep,name=multisig_staker_btc_pk_hexs,json=multisigStakerBtcPkHexs,proto3" json:"multisig_staker_btc_pk_hexs,omitempty"`
}
...
func (m *EventBTCDelegationCreated) GetMultisigStakerBtcPkHexs() []string {
	if m != nil {
		return m.MultisigStakerBtcPkHexs
	}
	return nil
}
...
var fileDescriptor_74118427820fff75 = []byte{
	...
	,
}
...
func (m *EventBTCDelegationCreated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MultisigStakerBtcPkHexs) > 0 {
		for iNdEx := len(m.MultisigStakerBtcPkHexs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.MultisigStakerBtcPkHexs[iNdEx])
			copy(dAtA[i:], m.MultisigStakerBtcPkHexs[iNdEx])
			i = encodeVarintEvents(dAtA, i, uint64(len(m.MultisigStakerBtcPkHexs[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
...
func (m *EventBTCDelegationCreated) Size() (n int) {
	...
	if len(m.MultisigStakerBtcPkHexs) > 0 {
		for _, s := range m.MultisigStakerBtcPkHexs {
			l = len(s)
			n += 1 + l + sovEvents(uint64(l))
		}
	}
...
func (m *EventBTCDelegationCreated) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MultisigStakerBtcPkHexs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MultisigStakerBtcPkHexs = append(m.MultisigStakerBtcPkHexs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
