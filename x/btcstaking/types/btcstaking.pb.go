...
type StakeExpansion struct {
	...
	// tx_input is the other input (TxIn) which was used to construct the BTC delegation
	// that is created from a previous active stake. The stake expansion has a set of
	// 2 inputs, the first input is the previous staking transaction and the second
	// input is to pay for fees and optionally to add more stake to the BTC delegation.
	TxInput []byte `protobuf:"bytes,2,opt,name=tx_input,json=txInput,proto3" json:"tx_input,omitempty"`
...
func (m *StakeExpansion) GetTxInput() []byte {
	if m != nil {
		return m.TxInput
	}
	return nil
...
var fileDescriptor_3851ae95ccfaf7db = []byte{
	...
	,
}
...
func (m *StakeExpansion) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TxInput) > 0 {
		i -= len(m.TxInput)
		copy(dAtA[i:], m.TxInput)
		i = encodeVarintBtcstaking(dAtA, i, uint64(len(m.TxInput)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *StakeExpansion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxInput", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxInput = append(m.TxInput[:0], dAtA[iNdEx:postIndex]...)
			if m.TxInput == nil {
				m.TxInput = []byte{}
			}
			iNdEx = postIndex
