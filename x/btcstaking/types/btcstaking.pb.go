...
type DelegatorUnbondingInfo struct {
	...
	// spend_stake_tx was included
	SpendStakeTxInclusionBlockHash []byte `protobuf:"bytes,2,opt,name=spend_stake_tx_inclusion_block_hash,json=spendStakeTxInclusionBlockHash,proto3" json:"spend_stake_tx_inclusion_block_hash,omitempty"`
...
func (m *DelegatorUnbondingInfo) GetSpendStakeTxInclusionBlockHash() []byte {
	if m != nil {
		return m.SpendStakeTxInclusionBlockHash
	}
	return nil
}

func (m *DelegatorUnbondingInfo) GetSpendStakeTxInclusionIndex() uint32 {
	if m != nil {
...
var fileDescriptor_3851ae95ccfaf7db = []byte{
	...
	,
}
...
func (m *DelegatorUnbondingInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SpendStakeTxInclusionIndex != 0 {
		i = encodeVarintBtcstaking(dAtA, i, uint64(m.SpendStakeTxInclusionIndex))
		i--
		dAtA[i] = 0x18
	}
	if len(m.SpendStakeTxInclusionBlockHash) > 0 {
		i -= len(m.SpendStakeTxInclusionBlockHash)
		copy(dAtA[i:], m.SpendStakeTxInclusionBlockHash)
		i = encodeVarintBtcstaking(dAtA, i, uint64(len(m.SpendStakeTxInclusionBlockHash)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *DelegatorUnbondingInfo) Size() (n int) {
	...
	l = len(m.SpendStakeTxInclusionBlockHash)
	if l > 0 {
		n += 1 + l + sovBtcstaking(uint64(l))
	}
	if m.SpendStakeTxInclusionIndex != 0 {
		n += 1 + sovBtcstaking(uint64(m.SpendStakeTxInclusionIndex))
	}
	return n
}
...
func (m *DelegatorUnbondingInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpendStakeTxInclusionBlockHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SpendStakeTxInclusionBlockHash = append(m.SpendStakeTxInclusionBlockHash[:0], dAtA[iNdEx:postIndex]...)
			if m.SpendStakeTxInclusionBlockHash == nil {
				m.SpendStakeTxInclusionBlockHash = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
