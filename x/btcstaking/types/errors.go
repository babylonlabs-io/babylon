...
var (
	...
	ErrNoBabylonFPMultiStaked    = errorsmod.Register(ModuleName, 1126, "BTC delegation must include at least one Babylon Genesis finality provider in its multi-staking selection")
