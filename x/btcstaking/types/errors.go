...
var (
	...
	ErrConsumerIDNotRegistered      = errorsmod.Register(ModuleName, 1127, "Consumer is not registered")
	ErrNoBabylonFPRestaked          = errorsmod.Register(ModuleName, 1128, "the BTC delegation request does not restake to any Babylon finality provider")
)
