...
var (
	...
	ErrUnableToSendCoins            = errorsmod.Register(ModuleName, 1131, "unable to send coins")
	ErrUnableToDistributeBsnRewards = errorsmod.Register(ModuleName, 1132, "unable to distribute BSN rewards")
	ErrFpInvalidBsnID               = errorsmod.Register(ModuleName, 1133, "finality provider has a different BSN ID")
	ErrUnableToAllocateBtcRewards   = errorsmod.Register(ModuleName, 1134, "unable to allocate BTC rewards")
)
