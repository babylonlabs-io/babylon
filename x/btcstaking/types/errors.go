...
var (
	...
	ErrRewardDistCacheNotFound      = errorsmod.Register(ModuleName, 1115, "the reward distribution cache is not found")
	ErrEmptyFpList                  = errorsmod.Register(ModuleName, 1116, "the finality provider list is empty")
	...
	ErrVotingPowerDistCacheNotFound = errorsmod.Register(ModuleName, 1120, "the voting power distribution cache is not found")
	ErrParamsNotFound               = errorsmod.Register(ModuleName, 1121, "the parameters are not found")
	ErrFpAlreadyJailed              = errorsmod.Register(ModuleName, 1122, "the finality provider has already been jailed")
	ErrFpNotJailed                  = errorsmod.Register(ModuleName, 1123, "the finality provider is not jailed")
	ErrDuplicatedCovenantSig        = errorsmod.Register(ModuleName, 1124, "the covenant signature is already submitted")
)
