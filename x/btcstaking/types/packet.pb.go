...
type BTCStakingIBCPacket struct {
	...
	SlashedFp   []*SlashedFinalityProvider `protobuf:"bytes,2,rep,name=slashed_fp,json=slashedFp,proto3" json:"slashed_fp,omitempty"`
	ActiveDel   []*ActiveBTCDelegation     `protobuf:"bytes,3,rep,name=active_del,json=activeDel,proto3" json:"active_del,omitempty"`
	SlashedDel  []*SlashedBTCDelegation    `protobuf:"bytes,4,rep,name=slashed_del,json=slashedDel,proto3" json:"slashed_del,omitempty"`
	UnbondedDel []*UnbondedBTCDelegation   `protobuf:"bytes,5,rep,name=unbonded_del,json=unbondedDel,proto3" json:"unbonded_del,omitempty"`
}
...
func (m *BTCStakingIBCPacket) GetSlashedFp() []*SlashedFinalityProvider {
	if m != nil {
		return m.SlashedFp
	}
	return nil
...
func (m *NewFinalityProvider) GetRegisteredEpoch() uint64 {
	if m != nil {
...
func (m *NewFinalityProvider) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
var fileDescriptor_3ed0d17ad14d6c0e = []byte{
	...
	,
}
...
func (m *NewFinalityProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RegisteredEpoch != 0 {
		i = encodeVarintPacket(dAtA, i, uint64(m.RegisteredEpoch))
		i--
		dAtA[i] = 0x38
	}
...
func (m *NewFinalityProvider) Size() (n int) {
	...
	if m.RegisteredEpoch != 0 {
		n += 1 + sovPacket(uint64(m.RegisteredEpoch))
	}
	if m.SlashedBabylonHeight != 0 {
