...
type ActiveBTCDelegation struct {
	...
	StakerAddr string `protobuf:"bytes,11,opt,name=staker_addr,json=stakerAddr,proto3" json:"staker_addr,omitempty"`
	...
	StartHeight uint32 `protobuf:"varint,3,opt,name=start_height,json=startHeight,proto3" json:"start_height,omitempty"`
...
var fileDescriptor_3ed0d17ad14d6c0e = []byte{
	...
	,
}
