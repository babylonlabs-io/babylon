...
// QueryNextHeightToFinalizeRequest is the request type for the Query/NextHeightToFinalize RPC method.
type QueryNextHeightToFinalizeRequest struct {
}

func (m *QueryNextHeightToFinalizeRequest) Reset()         { *m = QueryNextHeightToFinalizeRequest{} }
func (m *QueryNextHeightToFinalizeRequest) String() string { return proto.CompactTextString(m) }
func (*QueryNextHeightToFinalizeRequest) ProtoMessage()    {}
func (*QueryNextHeightToFinalizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{11}
}
func (m *QueryNextHeightToFinalizeRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryNextHeightToFinalizeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryNextHeightToFinalizeRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryNextHeightToFinalizeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryNextHeightToFinalizeRequest.Merge(m, src)
}
func (m *QueryNextHeightToFinalizeRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryNextHeightToFinalizeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryNextHeightToFinalizeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryNextHeightToFinalizeRequest proto.InternalMessageInfo

// QueryNextHeightToFinalizeResponse is the response type for the Query/NextHeightToFinalize RPC method.
type QueryNextHeightToFinalizeResponse struct {
	CurrentBlockHeight   uint64 `protobuf:"varint,1,opt,name=current_block_height,json=currentBlockHeight,proto3" json:"current_block_height,omitempty"`
	NextHeightToFinalize uint64 `protobuf:"varint,2,opt,name=next_height_to_finalize,json=nextHeightToFinalize,proto3" json:"next_height_to_finalize,omitempty"`
	MaxHeightToFinalize  uint64 `protobuf:"varint,3,opt,name=max_height_to_finalize,json=maxHeightToFinalize,proto3" json:"max_height_to_finalize,omitempty"`
	MaxFinalizedBlocks   uint64 `protobuf:"varint,4,opt,name=max_finalized_blocks,json=maxFinalizedBlocks,proto3" json:"max_finalized_blocks,omitempty"`
}

func (m *QueryNextHeightToFinalizeResponse) Reset()         { *m = QueryNextHeightToFinalizeResponse{} }
func (m *QueryNextHeightToFinalizeResponse) String() string { return proto.CompactTextString(m) }
func (*QueryNextHeightToFinalizeResponse) ProtoMessage()    {}
func (*QueryNextHeightToFinalizeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{12}
}
func (m *QueryNextHeightToFinalizeResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryNextHeightToFinalizeResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryNextHeightToFinalizeResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryNextHeightToFinalizeResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryNextHeightToFinalizeResponse.Merge(m, src)
}
func (m *QueryNextHeightToFinalizeResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryNextHeightToFinalizeResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryNextHeightToFinalizeResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryNextHeightToFinalizeResponse proto.InternalMessageInfo

func (m *QueryNextHeightToFinalizeResponse) GetCurrentBlockHeight() uint64 {
	if m != nil {
...
func (m *QueryNextHeightToFinalizeResponse) GetNextHeightToFinalize() uint64 {
	if m != nil {
...
func (m *QueryNextHeightToFinalizeResponse) GetMaxHeightToFinalize() uint64 {
	if m != nil {
		return m.MaxHeightToFinalize
	}
	return 0
}

func (m *QueryNextHeightToFinalizeResponse) GetMaxFinalizedBlocks() uint64 {
	if m != nil {
		return m.MaxFinalizedBlocks
	}
	return 0
}

// QueryVotingPowerTableRequest is the request type for the Query/VotingPowerTable RPC method.
type QueryVotingPowerTableRequest struct {
	BlockHeight uint64 `protobuf:"varint,1,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
}

func (m *QueryVotingPowerTableRequest) Reset()         { *m = QueryVotingPowerTableRequest{} }
func (m *QueryVotingPowerTableRequest) String() string { return proto.CompactTextString(m) }
func (*QueryVotingPowerTableRequest) ProtoMessage()    {}
func (*QueryVotingPowerTableRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{13}
}
func (m *QueryVotingPowerTableRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryVotingPowerTableRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryVotingPowerTableRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryVotingPowerTableRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryVotingPowerTableRequest.Merge(m, src)
}
func (m *QueryVotingPowerTableRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryVotingPowerTableRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryVotingPowerTableRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryVotingPowerTableRequest proto.InternalMessageInfo

func (m *QueryVotingPowerTableRequest) GetBlockHeight() uint64 {
	if m != nil {
...
// QueryVotingPowerTableResponse is the response type for the Query/VotingPowerTable RPC method.
type QueryVotingPowerTableResponse struct {
	Fps []*VotingPowerTableFpResponse `protobuf:"bytes,1,rep,name=fps,proto3" json:"fps,omitempty"`
}

func (m *QueryVotingPowerTableResponse) Reset()         { *m = QueryVotingPowerTableResponse{} }
func (m *QueryVotingPowerTableResponse) String() string { return proto.CompactTextString(m) }
func (*QueryVotingPowerTableResponse) ProtoMessage()    {}
func (*QueryVotingPowerTableResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{14}
}
func (m *QueryVotingPowerTableResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryVotingPowerTableResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryVotingPowerTableResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryVotingPowerTableResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryVotingPowerTableResponse.Merge(m, src)
}
func (m *QueryVotingPowerTableResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryVotingPowerTableResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryVotingPowerTableResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryVotingPowerTableResponse proto.InternalMessageInfo

func (m *QueryVotingPowerTableResponse) GetFps() []*VotingPowerTableFpResponse {
	if m != nil {
		return m.Fps
	}
	return nil
...
// VotingPowerTableFpResponse voting power table for each FP response.
type VotingPowerTableFpResponse struct {
	FpBtcPkHex  string `protobuf:"bytes,1,opt,name=fp_btc_pk_hex,json=fpBtcPkHex,proto3" json:"fp_btc_pk_hex,omitempty"`
	VotingPower uint64 `protobuf:"varint,2,opt,name=voting_power,json=votingPower,proto3" json:"voting_power,omitempty"`
}

func (m *VotingPowerTableFpResponse) Reset()         { *m = VotingPowerTableFpResponse{} }
func (m *VotingPowerTableFpResponse) String() string { return proto.CompactTextString(m) }
func (*VotingPowerTableFpResponse) ProtoMessage()    {}
func (*VotingPowerTableFpResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{15}
}
func (m *VotingPowerTableFpResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VotingPowerTableFpResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VotingPowerTableFpResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VotingPowerTableFpResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VotingPowerTableFpResponse.Merge(m, src)
}
func (m *VotingPowerTableFpResponse) XXX_Size() int {
	return m.Size()
}
func (m *VotingPowerTableFpResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VotingPowerTableFpResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VotingPowerTableFpResponse proto.InternalMessageInfo

func (m *VotingPowerTableFpResponse) GetFpBtcPkHex() string {
	if m != nil {
		return m.FpBtcPkHex
	}
	return ""
...
func (m *VotingPowerTableFpResponse) GetVotingPower() uint64 {
	if m != nil {
		return m.VotingPower
	}
	return 0
...
func (*QuerySigningInfosRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{35}
}
...
func (*QuerySigningInfosResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32bddab77af6fdae, []int{36}
}
...
func init() {
	...
	proto.RegisterType((*QueryNextHeightToFinalizeRequest)(nil), "babylon.finality.v1.QueryNextHeightToFinalizeRequest")
	proto.RegisterType((*QueryNextHeightToFinalizeResponse)(nil), "babylon.finality.v1.QueryNextHeightToFinalizeResponse")
	proto.RegisterType((*QueryVotingPowerTableRequest)(nil), "babylon.finality.v1.QueryVotingPowerTableRequest")
	proto.RegisterType((*QueryVotingPowerTableResponse)(nil), "babylon.finality.v1.QueryVotingPowerTableResponse")
	proto.RegisterType((*VotingPowerTableFpResponse)(nil), "babylon.finality.v1.VotingPowerTableFpResponse")
...
var fileDescriptor_32bddab77af6fdae = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// NextHeightToFinalize queries the next height in which finality will try to finalize
	NextHeightToFinalize(ctx context.Context, in *QueryNextHeightToFinalizeRequest, opts ...grpc.CallOption) (*QueryNextHeightToFinalizeResponse, error)
	// VotingPowerTable queries the voting power table at specific block height
	VotingPowerTable(ctx context.Context, in *QueryVotingPowerTableRequest, opts ...grpc.CallOption) (*QueryVotingPowerTableResponse, error)
...
func (c *queryClient) NextHeightToFinalize(ctx context.Context, in *QueryNextHeightToFinalizeRequest, opts ...grpc.CallOption) (*QueryNextHeightToFinalizeResponse, error) {
	out := new(QueryNextHeightToFinalizeResponse)
	err := c.cc.Invoke(ctx, "/babylon.finality.v1.Query/NextHeightToFinalize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VotingPowerTable(ctx context.Context, in *QueryVotingPowerTableRequest, opts ...grpc.CallOption) (*QueryVotingPowerTableResponse, error) {
	out := new(QueryVotingPowerTableResponse)
	err := c.cc.Invoke(ctx, "/babylon.finality.v1.Query/VotingPowerTable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// NextHeightToFinalize queries the next height in which finality will try to finalize
	NextHeightToFinalize(context.Context, *QueryNextHeightToFinalizeRequest) (*QueryNextHeightToFinalizeResponse, error)
	// VotingPowerTable queries the voting power table at specific block height
	VotingPowerTable(context.Context, *QueryVotingPowerTableRequest) (*QueryVotingPowerTableResponse, error)
	// ListPublicRandomness is a range query for public randomness of a given finality provider
	// NOTE: Babylon only has the knowledge of public randomness that is already revealed by
	// finality providers, i.e., the finality provider already provides a finality signature
	// at the corresponding height
...
func (*UnimplementedQueryServer) NextHeightToFinalize(ctx context.Context, req *QueryNextHeightToFinalizeRequest) (*QueryNextHeightToFinalizeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NextHeightToFinalize not implemented")
}
func (*UnimplementedQueryServer) VotingPowerTable(ctx context.Context, req *QueryVotingPowerTableRequest) (*QueryVotingPowerTableResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VotingPowerTable not implemented")
}
...
func _Query_NextHeightToFinalize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryNextHeightToFinalizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).NextHeightToFinalize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/babylon.finality.v1.Query/NextHeightToFinalize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).NextHeightToFinalize(ctx, req.(*QueryNextHeightToFinalizeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_VotingPowerTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryVotingPowerTableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).VotingPowerTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/babylon.finality.v1.Query/VotingPowerTable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).VotingPowerTable(ctx, req.(*QueryVotingPowerTableRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NextHeightToFinalize",
			Handler:    _Query_NextHeightToFinalize_Handler,
		},
		{
			MethodName: "VotingPowerTable",
			Handler:    _Query_VotingPowerTable_Handler,
		},
		{
...
func (m *QueryNextHeightToFinalizeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryNextHeightToFinalizeRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryNextHeightToFinalizeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryNextHeightToFinalizeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryNextHeightToFinalizeResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryNextHeightToFinalizeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxFinalizedBlocks != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.MaxFinalizedBlocks))
		i--
		dAtA[i] = 0x20
	}
	if m.MaxHeightToFinalize != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.MaxHeightToFinalize))
		i--
		dAtA[i] = 0x18
	}
	if m.NextHeightToFinalize != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.NextHeightToFinalize))
		i--
		dAtA[i] = 0x10
	}
...
func (m *QueryVotingPowerTableRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryVotingPowerTableRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryVotingPowerTableRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryVotingPowerTableResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryVotingPowerTableResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryVotingPowerTableResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Fps) > 0 {
		for iNdEx := len(m.Fps) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Fps[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *VotingPowerTableFpResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VotingPowerTableFpResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VotingPowerTableFpResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryNextHeightToFinalizeRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryNextHeightToFinalizeResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.NextHeightToFinalize != 0 {
		n += 1 + sovQuery(uint64(m.NextHeightToFinalize))
	}
	if m.MaxHeightToFinalize != 0 {
		n += 1 + sovQuery(uint64(m.MaxHeightToFinalize))
	}
	if m.MaxFinalizedBlocks != 0 {
		n += 1 + sovQuery(uint64(m.MaxFinalizedBlocks))
	}
	return n
}

func (m *QueryVotingPowerTableRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryVotingPowerTableResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VotingPowerTableFpResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryNextHeightToFinalizeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryNextHeightToFinalizeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryNextHeightToFinalizeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryNextHeightToFinalizeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryNextHeightToFinalizeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryNextHeightToFinalizeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxHeightToFinalize", wireType)
			}
			m.MaxHeightToFinalize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxHeightToFinalize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxFinalizedBlocks", wireType)
			}
			m.MaxFinalizedBlocks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxFinalizedBlocks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueryVotingPowerTableRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryVotingPowerTableRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryVotingPowerTableRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryVotingPowerTableResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryVotingPowerTableResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryVotingPowerTableResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Fps = append(m.Fps, &VotingPowerTableFpResponse{})
			if err := m.Fps[len(m.Fps)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VotingPowerTableFpResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VotingPowerTableFpResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VotingPowerTableFpResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
