...
type VoteSig struct {
	...
	FinalitySig *github_com_babylonlabs_io_babylon_types.SchnorrEOTSSig `protobuf:"bytes,3,opt,name=finality_sig,json=finalitySig,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.SchnorrEOTSSig" json:"finality_sig,omitempty"`
}
...
type PublicRandomness struct {
	...
	PubRand *github_com_babylonlabs_io_babylon_types.SchnorrPubRand `protobuf:"bytes,3,opt,name=pub_rand,json=pubRand,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.SchnorrPubRand" json:"pub_rand,omitempty"`
}
...
type PubRandCommitWithPK struct {
	...
	FpBtcPk *github_com_babylonlabs_io_babylon_types.BIP340PubKey `protobuf:"bytes,1,opt,name=fp_btc_pk,json=fpBtcPk,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BIP340PubKey" json:"fp_btc_pk,omitempty"`
...
var fileDescriptor_52dc577f74d797d1 = []byte{
	...
	0x69, 0x39, 0xb0, 0xdb, 0xa4, 0x54, 0x28, 0x8a, 0xb8, 0x6c, 0xd3, 0xb4, 0x21, 0x42, 0xb5, 0x66,
	0x23, 0x8a, 0x10, 0xc2, 0xd8, 0xde, 0x59, 0xef, 0x28, 0xbb, 0x9e, 0x91, 0x67, 0xd6, 0x4d, 0xf8,
	0x15, 0x9c, 0xf8, 0x19, 0xfc, 0x00, 0xce, 0x08, 0xf5, 0xd8, 0x23, 0xea, 0x21, 0x42, 0x89, 0x10,
	0xfc, 0x0c, 0xe4, 0xf1, 0x6c, 0xd7, 0xdd, 0xba, 0x69, 0x10, 0xad, 0x7a, 0x9b, 0x79, 0xf3, 0x7d,
	...
	0x3c, 0x17, 0x56, 0x18, 0xe7, 0xaf, 0x2a, 0x58, 0xf7, 0xf3, 0x14, 0xba, 0xd2, 0x97, 0x04, 0x6d,
	0x43, 0x35, 0x17, 0xb1, 0x8d, 0x86, 0xd1, 0x34, 0xb7, 0x3e, 0x6a, 0x95, 0xa4, 0xd4, 0x72, 0x15,
	0xa4, 0x53, 0x79, 0x72, 0xba, 0x3e, 0x87, 0x35, 0x01, 0x3d, 0x80, 0xab, 0x34, 0xee, 0x91, 0x63,
	...
	0xc4, 0x21, 0x11, 0xf6, 0x82, 0x12, 0xb9, 0x59, 0x2a, 0x72, 0x4f, 0xa3, 0xf0, 0x14, 0x8f, 0xb6,
	0x61, 0x39, 0x65, 0x92, 0x78, 0x82, 0x46, 0xc2, 0xae, 0x28, 0xf2, 0x8d, 0x52, 0xf2, 0xd7, 0x4c,
	...
	0xfc, 0x1c, 0x8c, 0xaf, 0xf1, 0x99, 0x08, 0x72, 0x61, 0x85, 0x8f, 0x03, 0x25, 0xe8, 0x85, 0x6c,
	0x34, 0xa2, 0xd2, 0xae, 0x2a, 0xc5, 0xe6, 0xab, 0x14, 0x33, 0xf2, 0x5d, 0x85, 0x7c, 0x44, 0xe5,
	...
	,
}
