...
type FinalityProviderDistInfo struct {
	...
	// Status the FP status on the FP distribution info
	Status types.FinalityProviderStatus `protobuf:"varint,8,opt,name=status,proto3,enum=babylon.btcstaking.v1.FinalityProviderStatus" json:"status,omitempty"`
}
...
func (m *FinalityProviderDistInfo) GetStatus() types.FinalityProviderStatus {
	if m != nil {
		return m.Status
	}
	return types.FinalityProviderStatus_FINALITY_PROVIDER_STATUS_INACTIVE
}
...
var fileDescriptor_ca5b87e52e3e6d02 = []byte{
	...
	,
}
...
func (m *FinalityProviderDistInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Status != 0 {
		i = encodeVarintFinality(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x40
	}
	if m.IsSlashed {
...
func (m *FinalityProviderDistInfo) Size() (n int) {
	...
	if m.Status != 0 {
		n += 1 + sovFinality(uint64(m.Status))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= types.FinalityProviderStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
