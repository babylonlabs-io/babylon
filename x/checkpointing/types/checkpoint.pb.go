...
type RawCheckpointWithMeta struct {
	...
	BlsAggrPk *github_com_babylonlabs_io_babylon_v2_crypto_bls12381.PublicKey `protobuf:"bytes,3,opt,name=bls_aggr_pk,json=blsAggrPk,proto3,customtype=github.com/babylonlabs-io/babylon/v2/crypto/bls12381.PublicKey" json:"bls_aggr_pk,omitempty"`
...
type BlsSig struct {
	...
	// the block that individual BLS sigs are signed on
	BlockHash *BlockHash                                                      `protobuf:"bytes,2,opt,name=block_hash,json=blockHash,proto3,customtype=BlockHash" json:"block_hash,omitempty"`
	BlsSig    *github_com_babylonlabs_io_babylon_v2_crypto_bls12381.Signature `protobuf:"bytes,3,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/babylonlabs-io/babylon/v2/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
