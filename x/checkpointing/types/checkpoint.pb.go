...
type RawCheckpointWithMeta struct {
	...
	BlsAggrPk *github_com_babylonlabs_io_babylon_v2_crypto_bls12381.PublicKey `protobuf:"bytes,3,opt,name=bls_aggr_pk,json=blsAggrPk,proto3,customtype=github.com/babylonlabs-io/babylon/v4/crypto/bls12381.PublicKey" json:"bls_aggr_pk,omitempty"`
...
type BlsSig struct {
	...
	// the block that individual BLS sigs are signed on
	BlockHash *BlockHash                                                      `protobuf:"bytes,2,opt,name=block_hash,json=blockHash,proto3,customtype=BlockHash" json:"block_hash,omitempty"`
	BlsSig    *github_com_babylonlabs_io_babylon_v2_crypto_bls12381.Signature `protobuf:"bytes,3,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/babylonlabs-io/babylon/v4/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
...
var fileDescriptor_73996df9c6aabde4 = []byte{
	...
	0x94, 0x05, 0x6c, 0x35, 0x7b, 0x41, 0x8b, 0x04, 0x24, 0x69, 0x0a, 0xd1, 0x36, 0xa5, 0xb2, 0x13,
	0x21, 0x2d, 0x07, 0x6b, 0xc6, 0x9e, 0x8c, 0x87, 0xd8, 0x1e, 0xcb, 0x33, 0xee, 0x6e, 0x78, 0x02,
	0xd4, 0xd3, 0xbe, 0x40, 0x25, 0x24, 0x1e, 0x81, 0x47, 0xe0, 0xc2, 0x71, 0x8f, 0x68, 0x0f, 0xcb,
	0xaa, 0xbd, 0x20, 0x0e, 0x3c, 0x03, 0xf2, 0xd8, 0xd9, 0x36, 0x5b, 0x56, 0x2a, 0xa2, 0xb7, 0xf1,
	0xe7, 0xef, 0x37, 0x9e, 0xf9, 0xfe, 0xc8, 0xe0, 0x43, 0x8c, 0xf0, 0x22, 0xe0, 0x91, 0xe9, 0xfa,
	0xc4, 0x9d, 0xc7, 0x9c, 0x45, 0x92, 0x45, 0xd4, 0x3c, 0xde, 0xbd, 0x04, 0x18, 0x71, 0xc2, 0x25,
	0x87, 0x8d, 0x82, 0x6a, 0xac, 0x50, 0x8d, 0xe3, 0xdd, 0x66, 0x9b, 0x72, 0x4e, 0x03, 0x62, 0x2a,
	...
	0x99, 0x29, 0x17, 0x31, 0x11, 0xf9, 0xcb, 0xed, 0x97, 0x1a, 0xa8, 0x59, 0xe8, 0xf1, 0xe0, 0xd5,
	0xb7, 0xe0, 0x5d, 0x50, 0x21, 0x31, 0x77, 0x7d, 0x27, 0x4a, 0xc3, 0x86, 0xd6, 0xd1, 0x76, 0x74,
	0xeb, 0x96, 0x02, 0x0e, 0xd3, 0x10, 0x7e, 0x0c, 0x00, 0x0e, 0xb8, 0x3b, 0x77, 0x7c, 0x24, 0xfc,
	0xc6, 0x5a, 0x47, 0xdb, 0xd9, 0xec, 0xd7, 0x9e, 0xbf, 0x68, 0x57, 0xfa, 0x19, 0xfa, 0x35, 0x12,
	...
	,
	...
	,
}
