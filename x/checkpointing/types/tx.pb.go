...
type MsgInjectedCheckpoint struct {
	...
	PlaceholderAddr string                 `protobuf:"bytes,1,opt,name=placeholder_addr,json=placeholderAddr,proto3" json:"placeholder_addr,omitempty"`
	Ckpt            *RawCheckpointWithMeta `protobuf:"bytes,2,opt,name=ckpt,proto3" json:"ckpt,omitempty"`
	// extended_commit_info is the commit info including the vote extensions
	// from the previous proposal
	ExtendedCommitInfo *types1.ExtendedCommitInfo `protobuf:"bytes,3,opt,name=extended_commit_info,json=extendedCommitInfo,proto3" json:"extended_commit_info,omitempty"`
}
...
func (m *MsgInjectedCheckpoint) GetPlaceholderAddr() string {
	if m != nil {
		return m.PlaceholderAddr
	}
	return ""
}
...
func (m *MsgInjectedCheckpoint) GetExtendedCommitInfo() *types1.ExtendedCommitInfo {
	if m != nil {
...
var fileDescriptor_6b16c54750152c21 = []byte{
	...
	,
}
...
func (m *MsgInjectedCheckpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PlaceholderAddr) > 0 {
		i -= len(m.PlaceholderAddr)
		copy(dAtA[i:], m.PlaceholderAddr)
		i = encodeVarintTx(dAtA, i, uint64(len(m.PlaceholderAddr)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgInjectedCheckpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PlaceholderAddr", wireType)
			}
			...
			m.PlaceholderAddr = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
		...
		case 3:
			...
			if m.ExtendedCommitInfo == nil {
				m.ExtendedCommitInfo = &types1.ExtendedCommitInfo{}
			}
