...
type QueryHashesResponse struct {
	Hashes     []github_com_babylonlabs_io_babylon_v4_types.BTCHeaderHashBytes `protobuf:"bytes,1,rep,name=hashes,proto3,customtype=github.com/babylonlabs-io/babylon/v4/types.BTCHeaderHashBytes" json:"hashes,omitempty"`
...
type QueryContainsRequest struct {
	Hash *github_com_babylonlabs_io_babylon_v4_types.BTCHeaderHashBytes `protobuf:"bytes,1,opt,name=hash,proto3,customtype=github.com/babylonlabs-io/babylon/v4/types.BTCHeaderHashBytes" json:"hash,omitempty"`
}
...
func (m *QueryHashesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_babylonlabs_io_babylon_v4_types.BTCHeaderHashBytes
