...
type MsgInsertHeaders struct {
	...
	Headers []github_com_babylonlabs_io_babylon_v4_types.BTCHeaderBytes `protobuf:"bytes,2,rep,name=headers,proto3,customtype=github.com/babylonlabs-io/babylon/v4/types.BTCHeaderBytes" json:"headers,omitempty"`
}
