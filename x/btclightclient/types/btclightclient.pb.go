...
type BTCHeaderInfo struct {
	Header *github_com_babylonlabs_io_babylon_types.BTCHeaderBytes     `protobuf:"bytes,1,opt,name=header,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BTCHeaderBytes" json:"header,omitempty"`
