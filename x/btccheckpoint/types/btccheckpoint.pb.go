...
type BTCSpvProof struct {
	...
	ConfirmingBtcHeader *github_com_babylonlabs_io_babylon_v4_types.BTCHeaderBytes `protobuf:"bytes,4,opt,name=confirming_btc_header,json=confirmingBtcHeader,proto3,customtype=github.com/babylonlabs-io/babylon/v4/types.BTCHeaderBytes" json:"confirming_btc_header,omitempty"`
}
...
type TransactionKey struct {
	...
	Hash  *github_com_babylonlabs_io_babylon_v4_types.BTCHeaderHashBytes `protobuf:"bytes,2,opt,name=hash,proto3,customtype=github.com/babylonlabs-io/babylon/v4/types.BTCHeaderHashBytes" json:"hash,omitempty"`
}
...
func (m *BTCSpvProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			var v github_com_babylonlabs_io_babylon_v4_types.BTCHeaderBytes
