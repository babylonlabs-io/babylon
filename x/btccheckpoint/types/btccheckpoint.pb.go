...
type BTCSpvProof struct {
	...
	ConfirmingBtcHeader *github_com_babylonlabs_io_babylon_v2_types.BTCHeaderBytes `protobuf:"bytes,4,opt,name=confirming_btc_header,json=confirmingBtcHeader,proto3,customtype=github.com/babylonlabs-io/babylon/v2/types.BTCHeaderBytes" json:"confirming_btc_header,omitempty"`
}
