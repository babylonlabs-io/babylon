...
type BTCSpvProof struct {
	...
	ConfirmingBtcHeader *github_com_babylonlabs_io_babylon_v3_types.BTCHeaderBytes `protobuf:"bytes,4,opt,name=confirming_btc_header,json=confirmingBtcHeader,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BTCHeaderBytes" json:"confirming_btc_header,omitempty"`
}
...
type TransactionKey struct {
	...
	Hash  *github_com_babylonlabs_io_babylon_v3_types.BTCHeaderHashBytes `protobuf:"bytes,2,opt,name=hash,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BTCHeaderHashBytes" json:"hash,omitempty"`
}
...
type BTCCheckpointInfo struct {
	...
	BestSubmissionBtcBlockHash *github_com_babylonlabs_io_babylon_v3_types.BTCHeaderHashBytes `protobuf:"bytes,3,opt,name=best_submission_btc_block_hash,json=bestSubmissionBtcBlockHash,proto3,customtype=github.com/babylonlabs-io/babylon/v3/types.BTCHeaderHashBytes" json:"best_submission_btc_block_hash,omitempty"`
...
var fileDescriptor_e096cac78d49b0a6 = []byte{
	...
	,
}
...
func (m *BTCSpvProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			var v github_com_babylonlabs_io_babylon_v3_types.BTCHeaderBytes
