...
// source: babylon/coostaking/v1/rewards.proto
...
func (*HistoricalRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3525a1fa6aa320a, []int{0}
}
...
func (*CurrentRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3525a1fa6aa320a, []int{1}
}
...
type CoostakerRewardsTracker struct {
...
func (m *CoostakerRewardsTracker) Reset()         { *m = CoostakerRewardsTracker{} }
func (m *CoostakerRewardsTracker) String() string { return proto.CompactTextString(m) }
func (*CoostakerRewardsTracker) ProtoMessage()    {}
func (*CoostakerRewardsTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_a3525a1fa6aa320a, []int{2}
}
func (m *CoostakerRewardsTracker) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CoostakerRewardsTracker) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CoostakerRewardsTracker.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CoostakerRewardsTracker) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CoostakerRewardsTracker.Merge(m, src)
}
func (m *CoostakerRewardsTracker) XXX_Size() int {
	return m.Size()
}
func (m *CoostakerRewardsTracker) XXX_DiscardUnknown() {
	xxx_messageInfo_CoostakerRewardsTracker.DiscardUnknown(m)
}

var xxx_messageInfo_CoostakerRewardsTracker proto.InternalMessageInfo

func (m *CoostakerRewardsTracker) GetStartPeriodCumulativeReward() uint64 {
	if m != nil {
...
func init() {
	proto.RegisterType((*HistoricalRewards)(nil), "babylon.coostaking.v1.HistoricalRewards")
	proto.RegisterType((*CurrentRewards)(nil), "babylon.coostaking.v1.CurrentRewards")
	proto.RegisterType((*CoostakerRewardsTracker)(nil), "babylon.coostaking.v1.CoostakerRewardsTracker")
}

func init() {
	proto.RegisterFile("babylon/coostaking/v1/rewards.proto", fileDescriptor_a3525a1fa6aa320a)
}

var fileDescriptor_a3525a1fa6aa320a = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CoostakerRewardsTracker) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CoostakerRewardsTracker) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CoostakerRewardsTracker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CoostakerRewardsTracker) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CoostakerRewardsTracker) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CoostakerRewardsTracker: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CoostakerRewardsTracker: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
