...
type EpochQueue struct {
	...
	// queue is a slice containing all the epochs' queued messages
	Queue []*EpochQueueEntry `protobuf:"bytes,2,rep,name=queue,proto3" json:"queue,omitempty"`
}
...
func (m *EpochQueue) GetQueue() []*EpochQueueEntry {
	if m != nil {
		return m.Queue
	}
	return nil
...
// EpochQueueEntry contains the queued message and the queue length
type EpochQueueEntry struct {
	// msg is the enqueued message
	Msg *QueuedMessage `protobuf:"bytes,1,opt,name=msg,proto3" json:"msg,omitempty"`
	// queue_length is the current length of the queue
	QueueLength uint64 `protobuf:"varint,2,opt,name=queue_length,json=queueLength,proto3" json:"queue_length,omitempty"`
}

func (m *EpochQueueEntry) Reset()         { *m = EpochQueueEntry{} }
func (m *EpochQueueEntry) String() string { return proto.CompactTextString(m) }
func (*EpochQueueEntry) ProtoMessage()    {}
func (*EpochQueueEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef836361c424501, []int{2}
}
func (m *EpochQueueEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EpochQueueEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EpochQueueEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EpochQueueEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EpochQueueEntry.Merge(m, src)
}
func (m *EpochQueueEntry) XXX_Size() int {
	return m.Size()
}
func (m *EpochQueueEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_EpochQueueEntry.DiscardUnknown(m)
}

var xxx_messageInfo_EpochQueueEntry proto.InternalMessageInfo

func (m *EpochQueueEntry) GetMsg() *QueuedMessage {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (m *EpochQueueEntry) GetQueueLength() uint64 {
	if m != nil {
...
func (*EpochValidatorSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ef836361c424501, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*EpochQueueEntry)(nil), "babylon.epoching.v1.EpochQueueEntry")
...
var fileDescriptor_2ef836361c424501 = []byte{
	...
	,
}
...
func (m *EpochQueueEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EpochQueueEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EpochQueueEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.QueueLength != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.QueueLength))
		i--
		dAtA[i] = 0x10
	}
	if m.Msg != nil {
...
func (m *EpochQueueEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.QueueLength != 0 {
		n += 1 + sovGenesis(uint64(m.QueueLength))
	}
	return n
}
...
func (m *EpochQueue) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Queue = append(m.Queue, &EpochQueueEntry{})
...
func (m *EpochQueueEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EpochQueueEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EpochQueueEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
