...
var (
	...
	ChainInfoKey          = []byte{0x12} // ChainInfoKey defines the key to store the chain info for each BSN in store
	CanonicalChainKey     = []byte{0x13} // CanonicalChainKey defines the key to store the canonical chain for each BSN in store
	ForkKey               = []byte{0x14} // ForkKey defines the key to store the forks for each BSN in store
	EpochChainInfoKey     = []byte{0x15} // EpochChainInfoKey defines the key to store each epoch's latests chain info for each BSN in store
