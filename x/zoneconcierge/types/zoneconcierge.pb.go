...
import (
	...
	types3 "github.com/babylonlabs-io/babylon/v2/x/btclightclient/types"
...
type ProofFinalizedChainInfo struct {
	// proof_bsn_header_in_epoch is the proof that the BSN's header is timestamped
	// within a certain epoch
	ProofBsnHeaderInEpoch *crypto.ProofOps `protobuf:"bytes,1,opt,name=proof_bsn_header_in_epoch,json=proofBsnHeaderInEpoch,proto3" json:"proof_bsn_header_in_epoch,omitempty"`
...
func (m *ProofFinalizedChainInfo) GetProofBsnHeaderInEpoch() *crypto.ProofOps {
	if m != nil {
		return m.ProofBsnHeaderInEpoch
	}
	return nil
}
...
var fileDescriptor_ab886e1868e5c5cd = []byte{
	...
	,
}
...
func (m *ProofFinalizedChainInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProofBsnHeaderInEpoch != nil {
		{
			size, err := m.ProofBsnHeaderInEpoch.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ProofFinalizedChainInfo) Size() (n int) {
	...
	_ = l
	if m.ProofBsnHeaderInEpoch != nil {
		l = m.ProofBsnHeaderInEpoch.Size()
		n += 1 + l + sovZoneconcierge(uint64(l))
	}
	if m.ProofEpochSealed != nil {
...
func (m *ProofFinalizedChainInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProofBsnHeaderInEpoch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProofBsnHeaderInEpoch == nil {
				m.ProofBsnHeaderInEpoch = &crypto.ProofOps{}
			}
			if err := m.ProofBsnHeaderInEpoch.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
