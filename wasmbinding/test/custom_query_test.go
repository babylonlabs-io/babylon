...
func TestQueryNonExistingHeader(t *testing.T) {
	...
	resp := bindings.BtcHeaderQueryResponse{}
	queryCustom(t, ctx, babylonApp, contractAddress, queryNonExistingHeight, &resp, nil)
	...
	queryCustom(t, ctx, babylonApp, contractAddress, queryNonExistingHash, &resp1, errors.New("Generic error: Querier contract error: codespace: btclightclient, code: 1100: query wasm contract failed"))
