...
func getChannelsIfPresent(events []RelayerEvent) []zapcore.Field {
...
func (cc *CosmosProvider) LogFailedTx(res *RelayerTxResponse, err error, msgs []RelayerMessage) {
...
func (cc *CosmosProvider) LogSuccessTx(res *sdk.TxResponse, msgs []RelayerMessage) {
	// Include the chain_id
	fields := []zapcore.Field{zap.String("chain_id", cc.ChainId())}
...
func msgTypesField(msgs []RelayerMessage) zap.Field {
