...
func testProviderWithKeystore(t *testing.T, accountPrefix string, extraCodecs []string) relayerclient.ChainProvider {
	homePath := t.TempDir()
	...
	p, err := cfg.NewProvider(zap.NewNop(), homePath, "test_chain")
	if err != nil {
